...
def start_recording(on_error=None):
    ...
    android_activity.bind(on_activity_result=lambda *a: _on_activity_result(*a, on_error=on_error))
...
def _on_activity_result(request_code, result_code, data, on_error=None):
